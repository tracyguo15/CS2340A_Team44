        ...
        toHomeScreen.setOnClickListener(v -> {
            ...
            if (theResult == 1) {
                Toast.makeText(CreateAccountActivity.this,
                        "Please enter an username!", Toast.LENGTH_SHORT).show();
            } else if (theResult == 2) {
                Toast.makeText(CreateAccountActivity.this,
                ...
                Toast.makeText(CreateAccountActivity.this,
                        "Passwords isn't long enough", Toast.LENGTH_SHORT).show();
            } else if (theResult == 6) {
                Toast.makeText(CreateAccountActivity.this,
                        "No spaces allowed", Toast.LENGTH_SHORT).show();
            } else if (theResult == 7) {
                Toast.makeText(CreateAccountActivity.this,
                        "Please put your password in confirmPassword!",
                ...
                Intent theIntent = new Intent(CreateAccountActivity.this,
                        com.example.androidprojecttemplate.LoginPageActivity.class);
